    ...
    return (
        <div className="shadow rounded-lg max-w-sm bg-gray-800 border-gray-100">
            ...
            <div className="px-5 pb-5">
                <a href="#">
                    <h3 className="font-semibold text-xl tracking-tighttext-white">
                        {name}
                    </h3>
                </a>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex">
                        <button
                            onClick={onAddToCart}
                            className="text-white mr-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue-600 hover:bg-blue-700 focus:ring-blue-800">
